            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl font-bold">Work Pro Tool</h2>
                ...
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl font-bold">Harbor Frieght Tool</h2>
                        <p>If you are in present world then you should use modern equipment in your work place.</p>
                        <p className='text-secondary pt-3 font-bold' style={{ fontFamily: 'Merienda' }}>Available</p>
                    </div>
                </div>
                <div className="card lg:max-w-lg bg-base-100 shadow-xl">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl font-bold">Insulated Tool</h2>
                        <p>If you are in present world then you should use modern equipment in your work place.</p>
                        <p className='text-secondary pt-3 font-bold' style={{ fontFamily: 'Merienda' }}>Available</p>
                    </div>
                </div>

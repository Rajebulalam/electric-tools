            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='w-full lg:w-6/12'>
                        ...
                        <p className="md:pr-16 py-5 text-gray-600 font-medium">Order your equipment any time and we will safely delivery them straight to your home. We will deliver it on time so you can relax.</p>
                        <button style={{ borderRadius: '0px 25px 25px 35px' }} className="btn btn-primary bg-gradient-to-b from-accent to-neutral text-white hover:bg-gradient-to-b hover:from-white hover:to-white hover:text-secondary font-bold hover:border-secondary px-5">Get Started</button>
                    </div>
                </div>
            </div>
        </div>
